...
%
par_wor_name='A64x32es';       % ['STRING'] 8-char (output) config name
par_gcm='k1';                  % ['STRING'] input format/GCM name
par_expid='epcs6432';            % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
...
par_min_Dk=16;                  % [1-99] minimum ocean depth (as # levels)
par_min_k=1;                   % [1-99] maximum ocean depth (k value)
par_lon_off=-2.8125;              % [-360-0] longitude offset of grid start
...
par_age=2800.0;                 % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%

...
#
# GOLDSTEIN
go_sodaylen=64800                      #solar day length
go_sidaylen=64665                      #sidereal day length
go_8=480                               #days per year
go_ediffpow1=1
go_ieos=1
go_iediff=1
go_ediff0=0.00001
...
# GOLDSTEINSEAICE
gs_sodaylen=64800                      #solar day length
gs_sidaylen=64665                      #sidereal day length
gs_8=480                               #days per year
gs_scf=1.5310134887695313
# EMBM
ea_sodaylen=64800                      #solar day length
ea_sidaylen=64665                      #sidereal day length
ea_8=480                               #days per year
ea_taux_u='R18.taux_u.dat'
ea_tauy_u='R18.tauy_u.dat'
ea_taux_v='R18.taux_v.dat'
ea_tauy_v='R18.tauy_v.dat'
ea_adv_u='R18.wvelx.dat'
ea_adv_v='R18.wvely.dat'
ea_par_albedo1d_name='R18.albd.dat'
#
# --- CLIMATE ---------------------------------------------------------
# 
# solar constant
...
bg_par_windspeed_file='R18.windspeed.dat'
